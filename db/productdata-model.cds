...
context interaction {
    entity Product {
        key productId   : Integer; // Auto-generated numerical ID
            ...
            masterClass : Composition of MasterData
                              on masterClass.productId = $self; // Single MasterClass
    }
    ...
    entity MasterData {
        key masterDataNumber : Integer; // Identifier for MasterData, not auto-generated
            ...
            subCategories    : Composition of many subCategoriesData
                                   on subCategories.masterDataNumber = $self; // Composition to SubData
    }
    ...
    entity subCategoriesData {
        key subCategorieNumber : Integer; // Identifier for SubData, not auto-generated
            ...
            characteristics    : Composition of many Characteristic
                                     on characteristics.subCategorieNumber = $self; // Composition to Characteristic
    }
    ...
    entity Characteristic {
        key characteristicNumber : Integer; // Identifier for Characteristic, not auto-generated
            ...
            subCharacteristics   : Composition of many SubCharacteristic
                                       on subCharacteristics.characteristicNumber = $self; // Composition to SubCharacteristic
    }
    ...
    entity SubCharacteristic {
        key subCharacteristicNumber : Integer; // Identifier for SubCharacteristic, not auto-generated
            ...
            values                  : Composition of many CharacteristicValue
                                          on values.subCharacteristicNumber = $self; // Composition to CharacteristicValue
    }
