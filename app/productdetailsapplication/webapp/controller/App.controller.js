sap.ui.define(
    ...
    function(fioriLibrary, SplitContainer, Controller, XMLView) {
      ...
      return Controller.extend("com.productdetailsapplication.productdetailsapplication.controller.App", {
          ...
          setDetailPage: function () {
            this._loadView({
              id: "midView",
              viewName: "com.productdetailsapplication.productdetailsapplication.view.Detail"
          ...
          setDetailDetailPage: function () {
            this._loadView({
              id: "endView",
              viewName: "com.productdetailsapplication.productdetailsapplication.view.DetailDetail"
